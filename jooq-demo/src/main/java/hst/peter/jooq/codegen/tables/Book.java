...
public class Book extends TableImpl<BookRecord> implements Serializable {

    private static final long serialVersionUID = 163498633;

    /**
     * The reference instance of <code>demodb.book</code>
     */
    ...
    /**
     * The column <code>demodb.book.id</code>.
     */
    ...
    /**
     * The column <code>demodb.book.author_id</code>.
     */
    ...
    /**
     * The column <code>demodb.book.title</code>.
     */
    ...
    /**
     * The column <code>demodb.book.published_in</code>.
     */
    public final TableField<BookRecord, Long> PUBLISHED_IN = createField(DSL.name("published_in"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>demodb.book.language_id</code>.
     */
    public final TableField<BookRecord, Long> LANGUAGE_ID = createField(DSL.name("language_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * Create a <code>demodb.book</code> table reference
     */
    public Book() {
    ...
    /**
     * Create an aliased <code>demodb.book</code> table reference
     */
